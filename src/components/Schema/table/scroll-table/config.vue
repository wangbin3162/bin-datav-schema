  ...
  <div class="setting-panel-gui">
    ...
    <g-field-collapse label="列配置">
      <template #add>
        ...
        <b-button type="text" :disabled="config.columnWidth.length===0" @click="deleteLast" title="移除最后一个列配置">
          <b-icon name="delete" size="16"></b-icon>
        </b-button>
      </template>
      <div v-for="(s,index) in config.columnWidth" :key="index">
