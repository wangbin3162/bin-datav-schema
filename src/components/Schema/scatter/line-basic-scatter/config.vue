    ...
    <g-field-collapse label="图形">
      <g-field label="标记" flat>
        <g-input-number
          ...
          label="大小"
        />
        <g-select v-model="config.global.symbol" :data="PointerIconsOptions" inline label="形状" />
      </g-field>
      <g-field label="偏移" flat>
        <g-input-number
      ...
      <g-field label="统计线图">
        <g-select v-model="config.global.line.lineEcStat" :data="LineEcStatOptions" />
      </g-field>
      <g-field label="平滑曲线">
        <g-switch v-model="config.global.line.smooth" />
      </g-field>
    </g-field-collapse>
...
import { PointerIconsOptions, LineEcStatOptions } from '@/config/select-options'
