  ...
  <div class="setting-panel-gui">
    <g-field-collapse label="全局">
      <g-field label="圆心坐标" inline tooltip="仪表盘圆心（中心）坐标,支持设置成百分比">
        <g-input v-model="config.global.center[0]" inline="inline" label="水平位置"></g-input>
        <g-input v-model="config.global.center[1]" inline="inline" label="垂直位置"></g-input>
      </g-field>
      <g-field label="半径">
    ...
    <g-field-collapse label="标题" toggle v-model="config.title.show">
      <g-field label="位置" inline>
        <g-input v-model="config.title.offsetCenter[0]" inline="inline" label="水平位置"></g-input>
        <g-input v-model="config.title.offsetCenter[1]" inline="inline" label="垂直位置"></g-input>
      </g-field>
      <g-field label="文本" inline>
        <g-input-number v-model="config.title.width" inline="inline" label="宽度" :min="0" :max="1000"></g-input-number>
        <g-select v-model="config.title.overflow" :data="overflowTypes" label="超出换行/截断" inline="inline" />
      </g-field>
      <g-field label="文本样式" flat>
        <g-input-number v-model="config.title.fontSize" :min="0" :max="24" :step="1" suffix="px" inline label="字号" />
        <g-select v-model="config.title.fontWeight" :data="fontWeights" inline label="字体粗细" />
        <g-color-picker v-model="config.title.color" label="颜色" inline="inline-single" />
      </g-field>
    </g-field-collapse>
    ...
    <g-field-collapse label="详情" toggle v-model="config.detail.show">
      ...
      <g-field label="位置" inline>
        <g-input v-model="config.detail.offsetCenter[0]" inline="inline" label="水平位置"></g-input>
        <g-input v-model="config.detail.offsetCenter[1]" inline="inline" label="垂直位置"></g-input>
      </g-field>
      <g-field label="文本" inline>
        <g-input-number
          ...
          :max="1000"
        ></g-input-number>
        <g-select v-model="config.detail.overflow" :data="overflowTypes" label="超出换行/截断" inline="inline" />
      </g-field>
      <g-field label="文本样式" flat>
        <g-input-number v-model="config.detail.fontSize" :min="0" :max="24" :step="1" suffix="px" inline label="字号" />
        <g-select v-model="config.detail.fontWeight" :data="fontWeights" inline label="字体粗细" />
        <g-color-picker v-model="config.detail.color" label="颜色" inline="inline-single" />
      </g-field>
    </g-field-collapse>
        ...
        <template v-for="(item, index) in config.axisLine.lineStyle.color" :key="index">
          <g-field flat :label="`区域${index + 1}`">
            ...
            <g-input-number
              ...
              :precision="1"
            ></g-input-number>
            <g-color-picker v-model="config.axisLine.lineStyle.color[index][1]" label="颜色" inline="inline" />
          </g-field>
        </template>
      </g-field-collapse>
      <g-field label="宽度">
        <g-input-number v-model="config.axisLine.lineStyle.width" :min="0" :max="100" :step="1"></g-input-number>
      </g-field>
    </g-field-collapse>
    ...
    <g-field-collapse label="进度条" toggle v-model="config.progress.show">
      ...
      <g-field label="宽度">
        <g-input-number v-model="config.progress.width" :min="0" :max="100" :step="1"></g-input-number>
      </g-field>
      <g-field label="两端圆角">
        <div class="pt-5">
    ...
    <g-field-collapse label="分隔线" toggle v-model="config.splitLine.show">
      <g-field flat label="分隔线样式">
        ...
        <g-input-number v-model="config.splitLine.lineStyle.width" inline :min="1" :max="10" :step="1" label="线宽" />
        <g-select v-model="config.splitLine.lineStyle.type" inline :data="lineStyles" label="线型" />
        <g-input-number
          ...
          label="与轴线的距离"
        />
        <g-color-picker v-model="config.splitLine.lineStyle.color" label="颜色" inline="inline-single" />
      </g-field>
    </g-field-collapse>
    ...
    <g-field-collapse label="刻度" toggle v-model="config.axisTick.show">
      ...
      <g-field label="刻度线样式" flat>
        ...
        <g-input-number v-model="config.axisTick.lineStyle.width" inline :min="1" :max="10" :step="1" label="线宽" />
        ...
        <g-input-number
          ...
          label="与轴线的距离"
        />
        <g-color-picker v-model="config.axisTick.lineStyle.color" label="颜色" inline="inline-single" />
      </g-field>
    </g-field-collapse>
    ...
    <g-field-collapse label="刻度标签" toggle v-model="config.axisLabel.show">
      <g-field label="文字样式" flat>
        <g-input-number
          ...
          label="字号"
        />
        <g-select v-model="config.axisLabel.fontWeight" :data="fontWeights" inline label="字体粗细" />
        <g-color-picker v-model="config.axisLabel.color" label="颜色" inline="inline-single" />
        <g-input-number v-model="config.axisLabel.distance" :min="-100" :max="100" :step="1" label="与轴线的距离" />
      </g-field>
    </g-field-collapse>

    <g-field-collapse label="指针" toggle v-model="config.pointer.show">
      <g-field label="位置" flat>
        <g-input v-model="config.pointer.offsetCenter[0]" inline="inline" label="水平位置"></g-input>
        <g-input v-model="config.pointer.offsetCenter[1]" inline="inline" label="垂直位置"></g-input>
      </g-field>
    ...
    <g-field-collapse label="固定点" toggle v-model="config.anchor.show">
      <g-field label="位置" flat>
        <g-input v-model="config.anchor.offsetCenter[0]" inline="inline" label="水平位置"></g-input>
        <g-input v-model="config.anchor.offsetCenter[1]" inline="inline" label="垂直位置"></g-input>
      </g-field>
      <g-field label="固定点样式" flat>
        <g-input-number v-model="config.anchor.size" :min="0" :max="20" :step="1" inline label="大小"></g-input-number>
